...
attachShaderMetadata(rotate2dFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(worldToClip2dFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(worldToClip3dFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(remapFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(scaleRotate2dFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(inverseLerpFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(lightContributionFn, () => ({ d, std }), false, { d, std });
...
attachShaderMetadata(tonemapFn, () => ({ d, std }), false, { d, std });
