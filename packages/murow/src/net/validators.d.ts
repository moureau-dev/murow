 ...
 * ```
 */
export declare function validateTickNotTooOld(currentTick: number, tolerance?: number): <T extends Intent>(_peerId: string, intent: T) => boolean;
/**
 * Validate that intent tick is not too far in the future
 * @param currentTick Current server tick
 * @param tolerance Number of ticks to allow in the future (default: 5)
 */
export declare function validateTickNotTooFuture(currentTick: number, tolerance?: number): <T extends Intent>(_peerId: string, intent: T) => boolean;
/**
 ...
 */
export declare function validateTickRange(currentTick: number, pastTolerance?: number, futureTolerance?: number): <T extends Intent>(_peerId: string, intent: T) => boolean;
/**
 * Combine multiple validators with AND logic
 */
export declare function combineValidators<T extends Intent>(...validators: Array<(peerId: string, intent: T) => boolean>): (peerId: string, intent: T) => boolean;
/**
 * Validate that a numeric field is within a range
 */
export declare function validateRange(field: string, min: number, max: number): <T extends Intent>(_peerId: string, intent: T) => boolean;
/**
 * Validate that a field exists and is of expected type
 */
export declare function validateFieldType(field: string, expectedType: string): <T extends Intent>(_peerId: string, intent: T) => boolean;
