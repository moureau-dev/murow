 ...
 * ```
 */
export type IntentDataOnly<T> = T extends DefinedIntent<infer _K, infer U extends Intent> ? Omit<U, 'kind' | 'tick'> : never;
/**
 ...
 * ```
 */
export declare function defineIntent<K extends number, S extends Record<string, any>>(definition: IntentDefinition<K, S>): DefinedIntent<K, InferIntentType<K, S>>;
